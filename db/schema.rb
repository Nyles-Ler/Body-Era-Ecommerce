...
ActiveRecord::Schema[7.0].define(version: 2026_07_17_191652) do
  ...
  create_table "product_variants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "size", "colour"], name: "index_product_variants_on_product_id_and_size_and_colour", unique: true
